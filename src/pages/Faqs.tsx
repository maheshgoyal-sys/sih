...
const Faqs: React.FC = () => {
  ...
  const sickStepsEn = ['Immediately isolate the sick animals.','Call a veterinarian.','Inform local animal health authorities.','Disinfect the affected area.'];
  const sickStepsHi = ['तुरंत बीमार जानवरों को अलग करें।','पशु चिकित्सक को बुलाएँ।','स्थानीय पशु स्वास्थ्य विभाग को सूचना दें।','प्रभावित क्षेत्र को डिसइंफेक्ट करें।'];
  const [lang, setLang] = React.useState<'en'|'hi'>('en');
  const base = lang==='en'?faqsEn:faqsHi;
  const extra = lang==='en'?extraEn:extraHi;
  const steps = lang==='en'?sickStepsEn:sickStepsHi;
      ...
      <div className="max-w-3xl mx-auto bg-white rounded-xl border border-gray-200 shadow-sm p-6">
        ...
        <div className="space-y-3">
          ...
          <details className="bg-gray-50 rounded-lg p-4">
            <summary className="cursor-pointer list-none font-medium text-gray-800">Q5. {lang==='en'?'What should be done if several animals suddenly fall sick?':'यदि अचानक कई जानवर बीमार पड़ जाएँ तो क्या करना चाहिए?'}</summary>
